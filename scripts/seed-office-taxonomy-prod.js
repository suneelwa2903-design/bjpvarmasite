/**
 * Seed office taxonomy directly in production
 * Run: node scripts/seed-office-taxonomy-prod.js
 */
...
async function seedTaxonomy() {
  try {
    console.log('🌱 Seeding office taxonomy in production...')
    ...
    console.log('✅ Office taxonomy seeded successfully!')
    ...
    console.log('\nCategories:')
    Object.keys(NEW_OFFICE_TAXONOMY).forEach(cat => {
      console.log(`  - ${cat} (${NEW_OFFICE_TAXONOMY[cat].length} types)`)
    })
